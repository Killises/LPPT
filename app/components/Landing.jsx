      ...
      <Section id="home" className="relative overflow-hidden">
        ...
        <div className="container py-20 grid lg:grid-cols-2 gap-10 items-center">
          ...
          <motion.div initial={{ opacity: 0, scale: 0.98 }} whileInView={{ opacity: 1, scale: 1 }} viewport={{ once: true }} transition={{ duration: 0.5 }}>
            <div className="aspect-video rounded-3xl bg-slate-200/60 border border-slate-200 shadow-inner flex items-center justify-center">
              <span className="text-slate-500">Imagen/Mockup del sistema Ajax</span>
            </div>
          </motion.div>
        </div>
      </Section>
